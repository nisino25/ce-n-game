...
var isObject = typeof string === "object" && string !== null;
...
if (typeof string === "object") {
    ...
    // p.env = Math.round((47 / 100) * string.env);

    // p.clo = Math.round((47 / 100) * string.clo);

    // p.head = Math.round((47 / 100) * string.head);

    // p.mouth = Math.round((47 / 100) * string.mouth);

    // p.eyes = Math.round((47 / 100) * string.eyes);

    // p.top = Math.round((47 / 100) * string.top);
    p.env = string.env;
p.clo = string.clo;
p.head = string.head;
p.mouth = string.mouth;
p.eyes = string.eyes;
p.top = string.top;
